  ...
  <div class="row">
      ...
      <div class="col-sm-6">
          <div class="panel panel-default">
            <div class="panel-heading"><a href ="#"><span class="glyphicon glyphicon-user "></span>   Volunteer 1<i class="fa fa-link fa-1x"></i></a></div>
            </div>
          <div class="panel panel-default">
            <div class="panel-heading"><a href ="#"><span class="glyphicon glyphicon-user "></span>   Volunteer 2<i class="fa fa-link fa-1x"></i></a></div>
            </div>
          <div class="panel panel-default">
            <div class="panel-heading"><a href ="#"><span class="glyphicon glyphicon-user "></span>   Volunteer 3<i class="fa fa-link fa-1x"></i></a></div>
            </div>
          <div class="panel panel-default">
            <div class="panel-heading"><a href ="#"><span class="glyphicon glyphicon-user "></span>   Volunteer 4<i class="fa fa-link fa-1x"></i></a></div>
        </div>
  </div>
</div>
