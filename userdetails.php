			...
			<div class="col-sm-6 profile">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="form-group">
							<input type="text" class="form-control" id="headngo">
						</div>
						<label for="desc">About yourself: </label>
						<div class="form-group">
							<textarea class="form-control" rows=6 id="desc" placeholder= "200 characters max"></textarea>
						</div>
					</div>
				</div>
			</div>
					...
					<p class="img" id="im"><b>Image: </b></p>
     					<label for="browse">
     						<label id="click">Click to upload</label>
      						<img id="avatar" src='blank.gif' style="height: 250px; width:250px;">
      					</label>
