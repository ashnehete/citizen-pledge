...
  	<button type="button" class="btn btn-default bttn register"><b>Click to register</b></button></form>
  </div>
    </div>
<div class="col-sm-6">
    <p>Description</p>
...
  <div class="btn-toolbar">
 	<button type="submit" action="register.php" class="btn btn-default bttn submit rgstr"><b>Register</b></button> 	
  	<button type="button" class="btn btn-default bttn login"><b>Click to login</b></button></form>
  </div>
 </div>
</div>
<script>
